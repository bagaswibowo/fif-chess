...
export const DEFAULT_PUZZLES: Puzzle[] = [
  ...
  // 5. GRANDMASTER TRAPS & MASTER CLASS TACTICS
  {
    id: "p10",
    category: "opening",
    difficulty: "Sedang",
    fen: "r1bqk1nr/pppp1ppp/2n5/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 2 4",
    turn: "w",
    solutionUci: "f3g5",
    solutionSan: "Ng5",
    theme: "Serangan Hati Ayam (Fried Liver Attack)",
    description: "Serang titik f7 dengan Kuda g5 dan Gajah c4 untuk menekan pertahanan Hitam.",
    hintPiece: "Kuda Putih di f3.",
    hintExplanation: "Lompatkan Kuda ke g5 menggandakan serangan pada petak f7.",
    trickExplanation: "Trik Fried Liver Attack: Mengombinasikan Kuda g5 + Gajah c4 sebelum Hitam sempat rokade memicu kehancuran struktur pertahanan Hitam.",
  },
  {
    id: "p11",
    category: "opening",
    ...
    description: "Hitam mengorbankan kuda di e4 untuk merebut kontrol pusat dan menggarpu Gajah/Kuda Putih.",
    hintPiece: "Kuda Hitam di f6.",
    hintExplanation: "Pukul pion e4 dengan Kuda f6. Jika Putih memukul balik dengan Nxe4, susul dengan d5!",
    trickExplanation: "Trik Garpu Pusat: Taktik klasik dalam Pembukaan Dua Kuda / Italia di mana pengorbanan Kuda dibalas dengan garpu pion d7-d5.",
  },
  {
    id: "p12",
    category: "middlegame",
    difficulty: "Sulit",
    fen: "2r1r1k1/pp3ppp/8/8/8/3Q4/PPP2PPP/2R1R1K1 w - - 0 1",
    turn: "w",
    solutionUci: "e1e8",
    solutionSan: "Rxe8+",
    theme: "Defleksi Baris Belakang (Back-Rank Deflection)",
    description: "Bersihkan jalur baris belakang lawan dengan mengeliminasi benteng penjaga.",
    hintPiece: "Benteng Putih di e1.",
    hintExplanation: "Pukul benteng e8 secara langsung untuk memaksa pertukaran yang berujung keunggulan.",
    trickExplanation: "Trik Defleksi Baris Belakang: Memaksa perwira bertahan meninggalkan tugas utamanya.",
  },
  {
    id: "p13",
    category: "endgame",
    difficulty: "Sulit",
    fen: "r1b2rk1/pp3p1p/2p3p1/8/3B4/8/PPP2PPP/R3R1K1 w - - 0 1",
    turn: "w",
    solutionUci: "d4f6",
    solutionSan: "Bf6",
    theme: "Jebakan Gajah Petak Gelap (Boden's Mating Pattern)",
    description: "Kunci pergerakan raja lawan di sayap raja dengan menempatkan gajah di diagonal f6.",
    hintPiece: "Gajah Putih di d4.",
    hintExplanation: "Langkahkan Gajah ke f6 untuk memotong akses pelarian raja Hitam.",
    trickExplanation: "Trik Mating Pattern Boden: Memanfaatkan silangan dua gajah untuk mengepung raja yang terkurung.",
  }
];
